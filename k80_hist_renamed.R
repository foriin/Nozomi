...
###### Darjeeling in Dsuz ref genome ######
# Previously annotated as Chopper
...
p_k80_te <- ggplot(
  ...
  ggtitle("K80 values distribution for Nozomi,\nDarjeeling and Hayabusa insertions")

p_k80_te

pdf("outputs/plots/te_k80_ndh.pdf", width = 5, height = 3)
p_k80_te
dev.off()
...
p_genome <- ggplot(
  ...
  ggtitle("K80 values distribution for Nozomi\nin dm6, A6 and BL2969 genomes
")

p_genome

ggsave(
  "outputs/plots/nozomi_k80_hist.pdf",
  p_genome,
  width = 5,
  height = 3
)
